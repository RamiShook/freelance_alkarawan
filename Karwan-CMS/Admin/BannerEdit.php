                                    ...
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                        ...
                                                        id="en_banner_description"><?php echo $banner[2];?></textarea>
                                            </div>
                                       </div>
                                    </div>
        </td>
                                        ...
                                        <div class="control-group" >
                                            ...
                                            <div class="controls controls-row" >
                                                        <textarea class="input-block-level" rows="3"
                                                         ...
                                                         id="ar_banner_description"><?php echo $banner[10];?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                        </div>
...
<br>
<div class="control-group">
                                    <label class="control-label">Upload Image</label> Perfect Image : Width: 1920px; Height: 762px;
                                    <div class="controls">
